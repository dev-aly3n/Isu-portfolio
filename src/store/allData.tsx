...
export const biochapters: { title: string; desc: React.ReactElement<any> }[] = [
  {
    title: "Chapter One: The Beginning",
    desc: (
      <>
        Aly Mohamadi was born on 9 February 1998 in Iran. There is nothing fancy
        about his family, just a regular one with all problems in the world that
        a family could has. Anyway he raised and on the very old day at school
        he watched the movie of 'October Sky' that had been made base on a real
        story of a book, Rocket Boys. Story is about the life of its author
        Hoomer Hickam. He was born in very fucked up town that all who was born
        there, would be miner eventually. But Hoomer after all didn't give up
        and tried to reach to his dream, being a rocket boy and working in NASA.
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        So it's all and this is what happened to very young Aly. He started
        dreaming about it and he tried to be a rocket boy but in Iran?! His
        place was more fucked up than Hoomer's town. He went to university and
        attempted to start with cheaper stuff so made some water rockets and
        tried to improve them but you know what? He couldn't find a hand-pump
        that could survive in 20 bar pressure (about 20 times of atmosphere).
        Yes I know you can't believe it. But it's true. Why, because this
        country of mullahs has been boycotted. So Aly hadn't the stuff that his
        friend Julian bought from a store besides of his home in Germany. Anyway
        he tried even cheaper, Aly created a magazine about Aerospace and named
        it ASPAD. He made a website with Joomla as he worked with it since he
        was 14 and a blogger who wrote about rockets and water rockets. He
        worked on it days and nights. He even set an interview with Hoomer
        Hickam that eventually Hoomer answered his question very kindly. The
        website and magazine was so interesting but you know free volunteering
        works in a country that falling to bottom of poverty is not working. So
        it's the time for new chapter.
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        He started thinking about coding. He searched for the job offers. Aly
        needed inspiring to start it. Finally he found it. Inspired by growing
        of this industry and how creativity that he could put on it. So he
        started to learn. He learned html css and js from w3school. I know I
        know such a nice place for learning nothing. He wasted one year on
        w3school besides of his study of aerospace. But after a year he found
        out that there is better materials and started to learn from an iranian
        teacher and please let me bang my head against the wall. That was
        horrible. But one day he searched how to build a nav bar css js and
        found a guy whose name was Dev Ed on Youtube. Aly loved his course and
        his ability to english speaking. In result he searched about this guy
        and found his courses about js. So started learning again. Working on
        his code for days and nights with ultimate creativity that he had. How
        ever he had a lots of problem and left the coding for days but he came
  ...
  },
  {
    ...
    desc: (
      <>
        After all Aly completed 8 creative projects with different technologies
        that he learnt and he is still learning. But the most important thing
        that will happen in this chapter is finding a job. Yes Aly will find a
        nice job at this chapter. He thinks that he is ready to work with a nice
        team.
      </>
    ),
  },
  {
    ...
    desc: (
      <>
        ...
        <a
          href="https://staging.demmortaltreasure.com/auction"
          target="_blank"
          className="link-inside-text"
        >
          Dutch Auction
