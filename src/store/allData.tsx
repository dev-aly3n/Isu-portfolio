...
export const biochapters: { title: string; desc: React.ReactElement<any> }[] = [
  ...
  },
  {
    ...
    desc: <>Aly started to work with DeDogmaDAO at Feb 2022. It was exactly what he wanted. A brilliant team with an awesome and unique product. He worked as a Front-End developer on a NextJS project with typescript, tailwindcss, framer-motion and WAGMI hook for interacting with Web3 and Ethereum chains. The big challenge here was implementing the Dutch Auction that needed a huge knowledge of web3 concepts, you can mint a NFT in this page. Another fun and big challenge was implementing gameboard that is a non-realtime browser's card game for lottery.</>,
  },
];
